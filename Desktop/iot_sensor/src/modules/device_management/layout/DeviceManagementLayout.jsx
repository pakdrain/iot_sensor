...
const DeviceManagementLayout = ({ children }) => {
  const navigate = useNavigate();
  const location = useLocation();

  const tabs = [
    { label: 'Regions', path: '/device-management/regions' },
    { label: 'Cities', path: '/device-management/cities' },
    { label: 'Shops', path: '/device-management/shops' },
    { label: 'Freezers', path: '/device-management/freezers' },
    { label: 'Sensors', path: '/device-management/sensors' },
  ];
